 ...
 */
final class Version20181017003733 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE flight (id INT AUTO_INCREMENT NOT NULL, plane_id INT DEFAULT NULL, teacher_id INT DEFAULT NULL, student_id INT DEFAULT NULL, flight_time DOUBLE PRECISION NOT NULL, floor_time DOUBLE PRECISION NOT NULL, escale TINYINT(1) NOT NULL, is_flight_book TINYINT(1) NOT NULL, is_lpe TINYINT(1) NOT NULL, payment_type VARCHAR(255) NOT NULL, is_paid TINYINT(1) NOT NULL, escale_location VARCHAR(255) NOT NULL, start_at TIME NOT NULL, end_at TIME NOT NULL, day DATE NOT NULL, fuel DOUBLE PRECISION DEFAULT NULL, INDEX IDX_C257E60EF53666A8 (plane_id), INDEX IDX_C257E60E41807E1D (teacher_id), INDEX IDX_C257E60ECB944F1A (student_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
